    ...
    <div>
      ...
      <PageHeader title="Quotations" description="Programme pricing after opportunity — precedes client purchase order.">
        <EntityDialog
          ...
          title="New Quotation"
          description="Create a quotation linked to a client and programme."
          ...
          fields={[
            ...
            { name: 'opportunity', label: 'Opportunity', type: 'relation', relation: 'opportunities' },
            { name: 'quoteNo', label: 'Quotation No.', required: true },
            { name: 'revision', label: 'Revision' },
            { name: 'quotationType', label: 'Quotation Type', type: 'select', options: [
              { value: 'Training', label: 'Training' }, { value: 'Space Rental', label: 'Space Rental' }, { value: 'Consultancy', label: 'Consultancy' }, { value: 'Service', label: 'Service' }
            ] },
            ...
            { name: 'finalPrice', label: 'Final Price (RM)', type: 'number', min: 0, step: '0.01' },
            ...
            { name: 'pic', label: 'PIC' },
            { name: 'programmeTitle', label: 'Programme Title', full: true },
            { name: 'programmeCode', label: 'Programme Code' }
          ]}
        />
      </PageHeader>
