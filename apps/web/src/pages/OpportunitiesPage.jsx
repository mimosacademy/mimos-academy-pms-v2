    ...
    <div>
      ...
      <PageHeader title="Opportunities" description="First step in the programme flow — qualify demand before quotation.">
        ...
        <EntityDialog
          ...
          description="Register a new sales opportunity in the pipeline."
          triggerLabel="New Opportunity"
          fields={[
            { name: 'client', label: 'Client', type: 'relation', relation: 'clients', required: true },
            { name: 'title', label: 'Opportunity / Project', required: true, full: true },
            { name: 'forecastValue', label: 'Forecast Value (RM)', type: 'number', min: 0, step: '0.01', required: true },
            { name: 'opportunityStatus', label: 'Status', type: 'select', options: [
              { value: 'Early engagement', label: 'Early engagement' },
              { value: 'Qualified lead/Tender in progress', label: 'Qualified lead/Tender in progress' },
              { value: 'Proposal/Tender submitted', label: 'Proposal/Tender submitted' },
              { value: 'Negotiation stage', label: 'Negotiation stage' },
              { value: 'Verbal commitment', label: 'Verbal commitment' },
              { value: 'Contract signed/PO issued', label: 'Contract signed/PO issued' },
              { value: 'Lost/No-go', label: 'Lost/No-go' }
            ] },
            ...
            { name: 'salesman', label: 'Salesperson' },
            { name: 'year', label: 'Year', type: 'number', min: 2020, max: 2100 }
          ]}
        />
      </PageHeader>
